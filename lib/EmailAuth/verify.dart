...
import 'package:note_application/EmailAuth/signup.dart';

import '../Check_fun/wrapper.dart';
      ...
      body: Padding(
        ...
        child: Center(
            child: Text("Open your mail and click the link provided "
                "to verify email & reload this page",style:TextStyle(fontSize: 20,fontWeight: FontWeight.bold),)
        ),
      ),
      floatingActionButton: FloatingActionButton(
          onPressed: (() => reload()),
        child: Icon(Icons.restart_alt_outlined,color: Colors.red,),
      ),
    );
  }
}
